#ifndef HDB_VECTOR4_HPP
#define HDB_VECTOR4_HPP
...
public:
	...
	constexpr Vector(Vector<T, 3> a, Vector<T, 3> b) {
		Vector<T, 3> center = a + b;
		center.normalize();

		this->w = b.dot(a);

		*(Vector<T, 3>*)this = b.cross(a);
	}
	...
	constexpr Vector homogenize() {
		return *this /= w;
	}

	constexpr Vector homogenized() const {
		return *this / w;
	}
